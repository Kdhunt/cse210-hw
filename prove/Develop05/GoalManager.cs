...
class GoalManager{
	...
	/*
	//I WAS going to try and get creative here with saving and reloading the goals in JSON format instead of text so I could serialize
	//object and reload it, I added all the annotations and created anohther class to hold the goal data but
	//I just kept running into a seriialization issue with the goal classes on load so I gave up for now
	public void SaveGoals(){
		Console.Clear();
		GoalManagerData data = new GoalManagerData
		{
	...
	public void LoadGoals(){
        ...
        GoalManagerData data = JsonSerializer.Deserialize<GoalManagerData>(json);
        _score = data.Score;
